...
library(readr)
closeAllConnections()
setwd("C:/Users/samue/Documents/Git_Hub_Repository")
# this program looks at base Means generated from BLAST processing and compares the basemeans of two sets, it generates a file for shared an unique values
...
for(prot1 in indv1){
  ...
  while(count <= stopper){
    ...
    protein2 <- substring(indv2[count],1, unlist(gregexpr('t', indv2[count]))[1]-2)
    if(protein2 == prot1){
